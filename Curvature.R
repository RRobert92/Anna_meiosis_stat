...
P1 <- ggplot(metaI_C, aes("metaI_c", `Data`)) +
      geom_boxplot(alpha = 0.2, fill = "black") +
      theme_classic()
P1 <- Plot_generate(P1, metaI5_C, "metaI5_c", "orange2")
P1 <- Plot_generate(P1, metaI7_C, "metaI7_c", "orange3")
P1 <- Plot_generate(P1, metaII2_C, "metaII2_c", "orange3")
P1 <- Plot_generate(P1, metaII1_C, "metaII1_c", "orange3")
P1 <- Plot_generate(P1, lateanaII1_C, "lateanaII1_C", "orange3")
P1 <- Plot_generate(P1, lateanaII2_C, "lateanaII2_C", "orange3")
P1 <- Plot_generate(P1, lateanaII3_C, "lateanaII3_C", "orange3")
P1 <- Plot_generate(P1, ana_meta_1_C, "ana_meta_1_C", "orange3")
P1 <- Plot_generate(P1, ana_meta_2_C, "ana_meta_2_C", "orange3")
P1 <- Plot_generate(P1, anaI1_C, "anaI1_C", "orange3")
P1 <- Plot_generate(P1, anaI3_C, "anaI3_C", "orange3")
P1 <- Plot_generate(P1, anaI4_C, "anaI4_C", "orange3")
P1 <- Plot_generate(P1, anaI7_C, "anaI7_C", "orange3")
P1 <- Plot_generate(P1, anaII1_C, "anaII1_C", "orange3")
P1 <- Plot_generate(P1, anaII15_C, "anaII15_C", "orange3")
P1 <- Plot_generate(P1, lagX_C, "lagX_C", "orange3")
P1 <- Plot_generate(P1, lagX5_C, "lagX5_C", "orange3")
P1 <- Plot_generate(P1, lagX6_C, "lagX6_C", "orange3")
P1 <- Plot_generate(P1, lagX9_C, "lagX9_C", "orange3")
